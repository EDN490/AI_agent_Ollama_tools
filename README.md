...
7. **Python-programmet fungerer som forbindelsen** mellem LLM'en, filsystemet og eksterne tjenester.
8. Agenten arbejder kun inden for det **directory, hvor `agent.py` ligger**.
9. Den kan **generere programmer og gemme dem**, men har ikke mulighed for at køre kode.
